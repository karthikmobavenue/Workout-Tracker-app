    ...
    <div className="max-w-4xl mx-auto p-4 py-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-lg">
          {selectedDate 
            ? `Viewing workout for ${new Date(selectedDate + 'T00:00:00').toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}`
            : 'Upcoming workouts - click to expand and track your progress'
          }
        </p>
        {selectedDate && (
          <Button 
